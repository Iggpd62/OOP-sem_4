...
class Peasant extends BaseHero implements CharacterInterface {
    ...
    Peasant (String name, int health, int speed, int x, int y,int arrows, List<CharacterInterface> heroes1, List<CharacterInterface> heroes2) {
    ...
    private CharacterInterface findNearestEnemy() {
        ...
        for (CharacterInterface enemy : heroes2) {
            double distance = calculateDistance(enemy.getCoordinates().getX(), enemy.getCoordinates().getY());
